...
if (isset($_POST['confirm_order'])) {
    ...
    $sqlCancelOrder = "UPDATE orders SET order_state = 'Cancelled' WHERE order_id = '$order_id'";
    ...
    while ($orderRow = mysqli_fetch_assoc($resultAllOrders)) {
        ...
        if ($orderRow['order_state'] !== 'Confirmed' && $orderRow['order_state'] !== 'Cancelled') {
            echo "<td>
                    ...
                    <button onclick='cancelOrder({$orderRow['order_id']})' style='background: blue;'>Cancel</button>
                    <br>
